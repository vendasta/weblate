...
if "WEBLATE_SOCIAL_AUTH_VENDASTA_KEY" in os.environ:
    ...
    SOCIAL_AUTH_VENDASTA_OIDC_ENDPOINT = os.environ.get(
...
MT_GOOGLE_KEY = os.environ.get("WEBLATE_GOOGLE_CLOUD_API_KEY", None)
if MT_GOOGLE_KEY:
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {"anon": "100/day", "user": "20000/hour"},
